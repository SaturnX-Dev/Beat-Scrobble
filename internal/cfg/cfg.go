...
const (
	// BASE_URL_ENV                  = "BEAT_SCROBBLE_BASE_URL"
	DATABASE_URL_ENV               = "BEAT_SCROBBLE_DATABASE_URL"
	BIND_ADDR_ENV                  = "BEAT_SCROBBLE_BIND_ADDR"
	LISTEN_PORT_ENV                = "BEAT_SCROBBLE_LISTEN_PORT"
	ENABLE_STRUCTURED_LOGGING_ENV  = "BEAT_SCROBBLE_ENABLE_STRUCTURED_LOGGING"
	ENABLE_FULL_IMAGE_CACHE_ENV    = "BEAT_SCROBBLE_ENABLE_FULL_IMAGE_CACHE"
	LOG_LEVEL_ENV                  = "BEAT_SCROBBLE_LOG_LEVEL"
	MUSICBRAINZ_URL_ENV            = "BEAT_SCROBBLE_MUSICBRAINZ_URL"
	MUSICBRAINZ_RATE_LIMIT_ENV     = "BEAT_SCROBBLE_MUSICBRAINZ_RATE_LIMIT"
	ENABLE_LBZ_RELAY_ENV           = "BEAT_SCROBBLE_ENABLE_LBZ_RELAY"
	LBZ_RELAY_URL_ENV              = "BEAT_SCROBBLE_LBZ_RELAY_URL"
	LBZ_RELAY_TOKEN_ENV            = "BEAT_SCROBBLE_LBZ_RELAY_TOKEN"
	CONFIG_DIR_ENV                 = "BEAT_SCROBBLE_CONFIG_DIR"
	DEFAULT_USERNAME_ENV           = "BEAT_SCROBBLE_DEFAULT_USERNAME"
	DEFAULT_PASSWORD_ENV           = "BEAT_SCROBBLE_DEFAULT_PASSWORD"
	DEFAULT_THEME_ENV              = "BEAT_SCROBBLE_DEFAULT_THEME"
	DISABLE_DEEZER_ENV             = "BEAT_SCROBBLE_DISABLE_DEEZER"
	DISABLE_COVER_ART_ARCHIVE_ENV  = "BEAT_SCROBBLE_DISABLE_COVER_ART_ARCHIVE"
	DISABLE_MUSICBRAINZ_ENV        = "BEAT_SCROBBLE_DISABLE_MUSICBRAINZ"
	SUBSONIC_URL_ENV               = "BEAT_SCROBBLE_SUBSONIC_URL"
	SUBSONIC_PARAMS_ENV            = "BEAT_SCROBBLE_SUBSONIC_PARAMS"
	SKIP_IMPORT_ENV                = "BEAT_SCROBBLE_SKIP_IMPORT"
	ALLOWED_HOSTS_ENV              = "BEAT_SCROBBLE_ALLOWED_HOSTS"
	CORS_ORIGINS_ENV               = "BEAT_SCROBBLE_CORS_ALLOWED_ORIGINS"
	DISABLE_RATE_LIMIT_ENV         = "BEAT_SCROBBLE_DISABLE_RATE_LIMIT"
	THROTTLE_IMPORTS_MS            = "BEAT_SCROBBLE_THROTTLE_IMPORTS_MS"
	IMPORT_BEFORE_UNIX_ENV         = "BEAT_SCROBBLE_IMPORT_BEFORE_UNIX"
	IMPORT_AFTER_UNIX_ENV          = "BEAT_SCROBBLE_IMPORT_AFTER_UNIX"
...
func loadConfig(getenv func(string) string, version string) (*config, error) {
	...
	cfg.userAgent = fmt.Sprintf("Beat Scrobble %s (github.com/SaturnX-Dev/Beat-Scrobble)", version)
