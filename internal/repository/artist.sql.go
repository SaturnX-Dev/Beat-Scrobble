...
func (q *Queries) CountTopArtists(ctx context.Context, arg CountTopArtistsParams) (int64, error) {
	row := q.db.QueryRow(ctx, countTopArtists, arg.ListenedAt, arg.ListenedAt_2, arg.UserID)
...
VALUES ($1, $2, $3)
RETURNING id, musicbrainz_id, image, image_source, genres, bio, popularity, spotify_id, followers, search_vector
`
...
func (q *Queries) UpdateArtistMetadata(ctx context.Context, arg UpdateArtistMetadataParams) error {
	_, err := q.db.Exec(ctx, updateArtistMetadata,
		arg.ID,
		arg.Genres,
		arg.Bio,
		arg.Popularity,
